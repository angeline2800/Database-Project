...
<body>
		...
		<div class="updateOrchard">
			<form action="" method="post">
				<div class="editOrchard">
					...
					<input type = "text" name="orchard_location" id="orchard_location" value="<?php echo $orchard_location; ?>"><br/>
					<label>User ID</label>
	...
	?>
				...
				<script type="text/javascript">window.location="adminOrchard.php"</script>
	<?php
			}
			else
			{
