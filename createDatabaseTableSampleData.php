<?php	
	...
	SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
		...
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 10024 AS userID, 'GUH Group' AS userName, 'Lot 1240 & 1241, Bayan Lepas Free Industrial Zone, Phase 3, 11900, Bayan Lepas, Penang' AS userAdd,
		...
		UNION ALL
			...
			) AS temp_27 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 10027)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			...
			) AS temp_28 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 10028)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			...
			) AS temp_29 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 10029)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			...
			) AS temp_30 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 10030)
	) alias_User ";
	 ...
	 if (mysqli_query($conn, $sqlClientData))
	{
	 ...
	 //Insert Admin Data
	 $sqlAdminData = "INSERT INTO `Admin`(userID, employmentDate)
	 SELECT userID, employmentDate
		FROM (SELECT userID, employmentDate
		FROM (SELECT 10026 AS userID, '2021-06-30' AS employmentDate)
			AS temp_46 WHERE NOT EXISTS (SELECT userID FROM `Admin` WHERE userID = 10026)
		UNION ALL
			SELECT userID, employmentDate
			FROM (SELECT 10027 AS userID, '2021-06-30' AS employmentDate)
			AS temp_47 WHERE NOT EXISTS (SELECT userID FROM `Admin` WHERE userID = 10027)
		UNION ALL
			SELECT userID, employmentDate
			FROM (SELECT 10028 AS userID, '2022-03-03' AS employmentDate)
			AS temp_48 WHERE NOT EXISTS (SELECT userID FROM `Admin` WHERE userID = 10028)
		UNION ALL
			SELECT userID, employmentDate
			FROM (SELECT 10029 AS userID, '2022-03-03' AS employmentDate)
			AS temp_49 WHERE NOT EXISTS (SELECT userID FROM `Admin` WHERE userID = 10029)
		UNION ALL
			SELECT userID, employmentDate
			FROM (SELECT 10030 AS userID, '2022-01-17' AS employmentDate)
			AS temp_50 WHERE NOT EXISTS (SELECT userID FROM `Admin` WHERE userID = 10030)
	 ) alias_Admin " ;

	 if (mysqli_query($conn, $sqlAdminData))
	 {
	 }
	 else
	 {
	  ...
	  SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
		FROM (SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7001 AS TreeID, 'durian.jpg' AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
				'40m' AS tree_height,'108cm' AS diameter, 'Red' AS status, '1.493661, 110.220418' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5001 AS BlockID)
			...
			UNION ALL
				...
				'43m' AS tree_height,'112cm' AS diameter, 'Red' AS status, '1.493719, 110.220419' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5001 AS BlockID)
			...
			UNION ALL
				...
				'38m' AS tree_height,'110cm' AS diameter, 'Red' AS status,'1.493769, 110.220328' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5001 AS BlockID)
			...
			UNION ALL
				...
				'45m' AS tree_height,'116cm' AS diameter, 'Red' AS status,  '1.493787, 110.220252' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5001 AS BlockID)
			...
			UNION ALL
				...
				'41m' AS tree_height,'108cm' AS diameter, 'Red' AS status, '1.493871, 110.220410' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5001 AS BlockID)
			...
			UNION ALL
				...
				'15m' AS tree_height,'53cm' AS diameter, 'Red' AS status, '1.493843, 110.220334' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'57cm' AS diameter, 'Red' AS status, '1.493937, 110.220366' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			...
			UNION ALL
				...
				'17m' AS tree_height,'55cm' AS diameter, 'Red' AS status, '1.493844, 110.220441' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			...
			UNION ALL
				...
				'16m' AS tree_height,'58cm' AS diameter, 'Red' AS status,'1.493927, 110.220344' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			...
			UNION ALL
				...
				'19m' AS tree_height,'60cm' AS diameter, 'Red' AS status, '1.494005, 110.220417' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			...
			UNION ALL
				...
				'23m' AS tree_height,'55cm' AS diameter, 'Red' AS status, '1.493981, 110.220326' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			...
			UNION ALL
				...
				'20m' AS tree_height,'60cm' AS diameter, 'Red' AS status, '1.493872, 110.220332' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			...
			UNION ALL
				...
				'24m' AS tree_height,'56cm' AS diameter, 'Red' AS status, '1.493858, 110.220216' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			...
			UNION ALL
				...
				'22m' AS tree_height,'58cm' AS diameter, 'Red' AS status, '1.493952, 110.220122' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			...
			UNION ALL
				...
				'21m' AS tree_height,'57m' AS diameter, 'Red' AS status, '1.493847, 110.220077' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			...
			UNION ALL
				...
				'30m' AS tree_height,'65cm' AS diameter, 'Red' AS status, '1.494137, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			...
			UNION ALL
				...
				'27m' AS tree_height,'68cm' AS diameter, 'Red' AS status, '1.494093, 110.220261' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			...
			UNION ALL
				...
				'26m' AS tree_height,'67cm' AS diameter, 'Red' AS status, '1.494079, 110.220103' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			...
			UNION ALL
				...
				'28m' AS tree_height,'69cm' AS diameter, 'Red' AS status, '1.494098, 110.220468' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			...
			UNION ALL
				...
				'20m' AS tree_height,'66cm' AS diameter, 'Red' AS status, '1.494221, 110.220454' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			...
			UNION ALL
				...
				'17m' AS tree_height,'79cm' AS diameter, 'Red' AS status, '1.494329, 110.220251' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'75cm' AS diameter, 'Red' AS status, '1.494316, 110.220080' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			...
			UNION ALL
				...
				'20m' AS tree_height,'78cm' AS diameter, 'Red' AS status, '1.494385, 110.220066' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'74cm' AS diameter, 'Red' AS status, '1.494393, 110.220187' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'79cm' AS diameter, 'Red' AS status, '1.494461, 110.220034' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			...
			UNION ALL
				...
				'20m' AS tree_height,'66cm' AS diameter, 'Red' AS status, '1.494474, 110.220211' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'65cm' AS diameter, 'Red' AS status, '1.494557, 110.220203' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			...
			UNION ALL
				...
				'17m' AS tree_height,'66cm' AS diameter, 'Red' AS status, '1.494565, 110.220080' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			...
			UNION ALL
				...
				'19m' AS tree_height,'68cm' AS diameter, 'Red' AS status, '1.494536, 110.220305' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			...
			UNION ALL
				...
				'20m' AS tree_height,'70cm' AS diameter, 'Red' AS status, '1.494420, 110.220286' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			...
			UNION ALL
				...
				'5m' AS tree_height,'20cm' AS diameter, 'Red' AS status, '1.494310, 110.219774' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			...
			UNION ALL
				...
				'4m' AS tree_height,'18cm' AS diameter, 'Red' AS status, '1.494305, 110.219736' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			...
			UNION ALL
				...
				'4m' AS tree_height,'19cm' AS diameter, 'Red' AS status, '1.494299, 110.219699' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			...
			UNION ALL
				...
				'5m' AS tree_height,'21cm' AS diameter, 'Red' AS status, '1.494307, 110.219696' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			...
			UNION ALL
				...
				'6m' AS tree_height,'20cm' AS diameter, 'Red' AS status, '1.494309, 110.219645' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			...
			UNION ALL
				...
				'15m' AS tree_height,'45cm' AS diameter, 'Red' AS status, '1.494360, 110.219729' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			...
			UNION ALL
				...
				'14m' AS tree_height,'46cm' AS diameter, 'Red' AS status, '1.494385, 110.219803' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			...
			UNION ALL
				...
				'16m' AS tree_height,'47cm' AS diameter, 'Red' AS status, '1.494330, 110.219845' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			...
			UNION ALL
				...
				'15m' AS tree_height,'45cm' AS diameter, 'Red' AS status, '1.494312, 110.219771' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			...
			UNION ALL
				...
				'15m' AS tree_height,'43cm' AS diameter, 'Red' AS status, '1.494279, 110.219832' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			...
			UNION ALL
				...
				'28m' AS tree_height,'92cm' AS diameter, 'Green' AS status, '1.495474, 110.220234' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			...
			UNION ALL
				...
				'29m' AS tree_height,'90cm' AS diameter, 'Green' AS status, '1.495527, 110.220157' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			...
			UNION ALL
				...
				'22m' AS tree_height,'58cm' AS diameter, 'Red' AS status, '1.495504, 110.220330' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			...
			UNION ALL
				...
				'27m' AS tree_height,'68cm' AS diameter, 'Red' AS status, '1.495388, 110.220336' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			...
			UNION ALL
				...
				'15m' AS tree_height,'43cm' AS diameter, 'Red' AS status, '1.495393, 110.220223' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'74cm' AS diameter, 'Red' AS status, '1.495423, 110.220472' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			...
			UNION ALL
				...
				'2m' AS tree_height,'14cm' AS diameter, 'Green' AS status, '1.495341, 110.220502' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			...
			UNION ALL
				...
				'2m' AS tree_height,'13cm' AS diameter, 'Green' AS status, '1.495384, 110.220570' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			...
			UNION ALL
				...
				'2m' AS tree_height,'12cm' AS diameter, 'Green' AS status, '1.495424, 110.220629' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'66cm' AS diameter, 'Red' AS status, '1.495495, 110.220562' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			...
			UNION ALL
				...
				'15m' AS tree_height,'45cm' AS diameter, 'Red' AS status, '1.495582, 110.219419' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			...
			UNION ALL
				...
				'26m' AS tree_height,'68cm' AS diameter, 'Red' AS status, '1.495579, 110.219506' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			...
			UNION ALL
				...
				'23m' AS tree_height,'57cm' AS diameter, 'Red' AS status, '1.495514, 110.219417' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			...
			UNION ALL
				...
				'40m' AS tree_height,'110cm' AS diameter, 'Yellow' AS status, '1.495493, 110.219576' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			...
			UNION ALL
				...
				'40m' AS tree_height,'110cm' AS diameter, 'Red' AS status, '1.495594, 110.219593' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'73cm' AS diameter, 'Red' AS status, '1.495678, 110.219398' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'65cm' AS diameter, 'Red' AS status, '1.495676, 110.219519' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			...
			UNION ALL
				...
				'40m' AS tree_height,'110cm' AS diameter, 'Yellow' AS status, '1.495675, 110.219614' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			...
			UNION ALL
				...
				'26m' AS tree_height,'66cm' AS diameter, 'Yellow' AS status, '1.495741, 110.219575' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			...
			UNION ALL
				...
				'22m' AS tree_height,'57cm' AS diameter, 'Red' AS status, '1.495747, 110.219441' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			...
			UNION ALL
				...
				'15m' AS tree_height,'44cm' AS diameter, 'Red' AS status, '1.495931, 110.220590' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			...
			UNION ALL
				...
				'19m' AS tree_height,'68cm' AS diameter, 'Red' AS status, '1.495871, 110.220659' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			...
			UNION ALL
				...
				'40m' AS tree_height,'110cm' AS diameter, 'Red' AS status, '1.495872, 110.220745' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			...
			UNION ALL
				...
				'43m' AS tree_height,'112cm' AS diameter, 'Red' AS status, '1.495928, 110.220820' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			...
			UNION ALL
				...
				'17m' AS tree_height,'70cm' AS diameter, 'Red' AS status, '1.495938, 110.220715' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			...
			UNION ALL
				...
				'44m' AS tree_height,'111cm' AS diameter, 'Red' AS status, '1.496102, 110.220568' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			...
			UNION ALL
				...
				'14m' AS tree_height,'43cm' AS diameter, 'Red' AS status, '1.496101, 110.220717' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			...
			UNION ALL
				...
				'4m' AS tree_height,'19cm' AS diameter, 'Red' AS status, '1.496107, 110.220847' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			...
			UNION ALL
				...
				'4m' AS tree_height,'18cm' AS diameter, 'Red' AS status, '1.496136, 110.220626' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			...
			UNION ALL
				...
				'22m' AS tree_height,'58cm' AS diameter, 'Red' AS status, '1.496129, 110.220785' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'72cm' AS diameter, 'Yellow' AS status,'1.496038, 110.219456' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			...
			UNION ALL
				...
				'2m' AS tree_height,'14cm' AS diameter, 'Green' AS status,'1.496041, 110.219604' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			...
			UNION ALL
				...
				'40m' AS tree_height,'110cm' AS diameter, 'Red' AS status,'1.496002, 110.219534' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			...
			UNION ALL
				...
				'43m' AS tree_height,'113cm' AS diameter, 'Red' AS status,'1.495953, 110.219448' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			...
			UNION ALL
				...
				'44m' AS tree_height,'111cm' AS diameter, 'Red' AS status,'1.495955, 110.219552' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			...
			UNION ALL
				...
				'43m' AS tree_height,'115cm' AS diameter, 'Red' AS status,'1.496167, 110.219485' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
			...
			UNION ALL
				...
				'26m' AS tree_height,'66cm' AS diameter, 'Yellow' AS status,'1.496164, 110.219584' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
			...
			UNION ALL
				...
				'18m' AS tree_height,'66cm' AS diameter, 'Red' AS status,'1.496147, 110.219666' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
			...
			UNION ALL
				...
				'15m' AS tree_height,'45cm' AS diameter, 'Red' AS status,'1.496206, 110.219625' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
			...
			UNION ALL
				...
				'22m' AS tree_height,'58cm' AS diameter, 'Red' AS status,'1.496206, 110.219504' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
