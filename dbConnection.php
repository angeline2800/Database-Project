<?php	
	...
	SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
		...
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31001 AS userID, 'Amirah Aisyah Binti Karul' AS userName, 'No 18, Jalan Gani, 93050, Kuching, Sarawak' AS userAdd, 'amirah@gmail.com' AS userEmail, SHA1('Ami&40+') AS userPW,
			'0125674598' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_11 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31001)

		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31002 AS userID, 'Lam Kim Sam' AS userName, 'No 90, Jalan Green, 93150, Kuching, Sarawak' AS userAdd, 'kimsan@gmail.com' AS userEmail, SHA1('Kim*67M') AS userPW,
			'0194347890' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_12 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31002)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31003 AS userID, 'Muhammad Farid Bin Mohd Karim' AS userName, 'No 45, Jalan Istana, 93050, Kuching, Sarawak' AS userAdd, 'karim@gmail.com' AS userEmail, SHA1('kArim2#') AS userPW,
			'0101108903' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_13 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31003)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31004 AS userID, 'Amir Haji Bin Kharul' AS userName, 'No 88, Jalan Helang, 93050, Kuching, Sarawak' AS userAdd, 'amir13@gmail.com' AS userEmail, SHA1('amiR@&') AS userPW,
			'0179023125' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_14 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31004)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31005 AS userID, 'Lau Wei Ming' AS userName, 'No 66, Jalan Hijau, 93150, Kuching, Sarawak' AS userAdd, 'lau@gmail.com' AS userEmail, SHA1('Lau@wE') AS userPW,
			'0120932490' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_15 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31005)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31006 AS userID, 'Muhammad Fitri bin Musa' AS userName, 'No 113, Jalan Mewah, 93050, Kuching, Sarawak' AS userAdd, 'fitri@gmail.com' AS userEmail, SHA1('tRi&11') AS userPW,
			'0108705345' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_16 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31006)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31007 AS userID, 'Akesh Nair' AS userName, 'No 63, Taman Sentosa, 93150, Kuching, Sarawak' AS userAdd, 'akesh@gmail.com' AS userEmail, SHA1('ak97&1') AS userPW,
			'0181273561' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_17 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31007)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31008 AS userID, 'Lim Kok Kien' AS userName, 'No 85, Bukit Jade, 93050, Kuching, Sarawak' AS userAdd, 'kklim@gmail.com' AS userEmail, SHA1('85#Lim') AS userPW,
			'0162816878' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_18 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31008)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31009 AS userID, 'Javier Siow' AS userName, 'Lot 145, Jalan Indah, 93050, Kuching, Sarawak' AS userAdd, 
			'javier@gmail.com' AS userEmail, SHA1('jS127$') AS userPW,
			'0193937580' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_19 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31009)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 31010 AS userID, 'Venessa Sim' AS userName, 'No 1123, Jalan Batu 3, 93150, Kuching, Sarawak' AS userAdd, 'venessa@gmail.com' AS userEmail, SHA1('venes$98') AS userPW,
			'0123875576' AS userPhone, 'Malaysia' AS userCountry, 'client' AS userType  
			) AS temp_20 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 31010)

		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 68001 AS userID, 'Kuching Sincere Sdn Bhd' AS userName, 'Lot 1836 (SL 5), RJ Business Hub Kuching-Kota Samarahan Expressway, 94300 Kuching, Sarawak' AS userAdd,
			...
			) AS temp_21 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 68001)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 68002 AS userID, 'Evergreen Kuala Lumpur Sdn Bhd' AS userName, 'Level 16, The Gardens South Tower, Lingkaran Syed Putra, Mid Valley City, 59200 Kuala Lumpur' AS userAdd,
			...
			) AS temp_22 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 68002)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 68003 AS userID, 'Bunga Raya Corporate Sdn Bhd' AS userName, 'Level 19, Tower B, Plaza 33, No. 1, Jalan Kemajuan, Seksyen 13, Petaling Jaya, 46200 Petaling Jaya, Selangor' AS userAdd,
			'brc@brc.com.my' AS userEmail, SHA1('168brc@') AS userPW, '0378836333' AS userPhone, 'Malaysia' AS userCountry, 'company' AS userType  
			) AS temp_23 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 68003)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 68004 AS userID, 'GUH Group' AS userName, 'Plot 1240 & 1241, Bayan Lepas Free Industrial Zone, Phase 3, 11900, Bayan Lepas, Penang' AS userAdd,
			...
			) AS temp_24 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 68004)
		UNION ALL
			SELECT userID,userName,userAdd,userEmail,userPW,userPhone,userCountry,userType
			FROM (SELECT 68005 AS userID, 'Sarawak Consolidated Industries Berhad' AS userName, 'Lot 1258, Jalan Utama, Pending Industrial Estate, 93450 Kuching, Sarawak' AS userAdd,
			...
			) AS temp_25 WHERE NOT EXISTS (SELECT userID FROM User WHERE userID = 68005)
	) alias_User ";
	...
	SELECT userID,worker_position,worker_department,workerDOB
	 ...
	 SELECT userID,client_photo
		FROM (SELECT userID,client_photo
			FROM (SELECT 31001 AS userID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\woman.jpg') AS client_photo)
			AS temp_36 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31001)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31002 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_37 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31002)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31003 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_38 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31003)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31004 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_39 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31004)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31005 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_40 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31005)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31006 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_41 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31006)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31007 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_42 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31007)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31008 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_43 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31008)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31009 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_44 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31009)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 31010 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\woman.jpg') AS client_photo)
			AS temp_45 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 31010)
	 ) alias_Client";
	 ...
	 if (mysqli_query($conn, $sqlClientData))
	{
	 ...
	 SELECT userID,companyDesc,companyPhoto
		FROM (SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 68001 AS userID, 'Corporate office' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_46 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 68001)
		UNION ALL
			SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 68002 AS userID, 'Agricultural' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_47 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 68002)
		UNION ALL
			SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 68003 AS userID, 'Plantation' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_48 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 68003)
		UNION ALL
			SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 68004 AS userID, 'Manufacturer' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_49 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 68004)
		UNION ALL
			SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 68005 AS userID, 'Plantation' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_50 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 68005)
	 ) alias_Company " ;
	 ...
	 SELECT orchardID,orchard_add,orchard_location,userID
		FROM (SELECT orchardID,orchard_add,orchard_location,userID
			FROM (SELECT 2001 AS orchardID, 'Lot 118A, Jalan Sematan, Batu Kawa, 93250 Kuching, Sarawak' AS orchard_add, '1.493661, 110.220412' AS orchard_location, 68003 AS userID)
			AS temp_51 WHERE NOT EXISTS (SELECT orchardID FROM Orchard WHERE orchardID = 2001)
		UNION ALL
			SELECT orchardID,orchard_add,orchard_location,userID
			FROM (SELECT 2002 AS orchardID, 'Lot 118B, Jalan Sematan, Batu Kawa, 93250 Kuching, Sarawak' AS orchard_add, '1.493901, 110.220412' AS orchard_location, 68003 AS userID)
			AS temp_52 WHERE NOT EXISTS (SELECT orchardID FROM Orchard WHERE orchardID = 2002)
		UNION ALL
			SELECT orchardID,orchard_add,orchard_location,userID
			FROM (SELECT 2003 AS orchardID, 'Lot 119A, Jalan Sematan, Batu Kawa, 93250 Kuching, Sarawak' AS orchard_add, '1.494305, 110.220380' AS orchard_location, 68002 AS userID)
			AS temp_53 WHERE NOT EXISTS (SELECT orchardID FROM Orchard WHERE orchardID = 2003)
		UNION ALL
			SELECT orchardID,orchard_add,orchard_location,userID
			FROM (SELECT 2004 AS orchardID, 'Lot 119B, Jalan Sematan, Batu Kawa, 93250 Kuching, Sarawak' AS orchard_add, '1.494294, 110.219822' AS orchard_location, 68005 AS userID)
			AS temp_54 WHERE NOT EXISTS (SELECT orchardID FROM Orchard WHERE orchardID = 2004)
		UNION ALL
			SELECT orchardID,orchard_add,orchard_location,userID
			FROM (SELECT 2005 AS orchardID, 'Lot 220A, Jalan Sematan, Batu Kawa, 93250 Kuching, Sarawak' AS orchard_add, '1.495369, 110.220404' AS orchard_location, 68005 AS userID)
			AS temp_55 WHERE NOT EXISTS (SELECT orchardID FROM Orchard WHERE orchardID = 2005)
		UNION ALL
			SELECT orchardID,orchard_add,orchard_location,userID
			FROM (SELECT 2006 AS orchardID, 'Lot 220B, Jalan Sematan, Batu Kawa, 93250 Kuching, Sarawak' AS orchard_add, '1.495603, 110.219522' AS orchard_location, 68004 AS userID)
			AS temp_56 WHERE NOT EXISTS (SELECT orchardID FROM Orchard WHERE orchardID = 2006)
		UNION ALL
			SELECT orchardID,orchard_add,orchard_location,userID
			FROM (SELECT 2007 AS orchardID, 'Lot 221A, Jalan Sematan, Batu Kawa, 93250 Kuching, Sarawak' AS orchard_add, '1.496000, 110.220724' AS orchard_location, 68004 AS userID)
			AS temp_57 WHERE NOT EXISTS (SELECT orchardID FROM Orchard WHERE orchardID = 2007)
		UNION ALL
			SELECT orchardID,orchard_add,orchard_location,userID
			FROM (SELECT 2008 AS orchardID, 'Lot 221B, Jalan Sematan, Batu Kawa, 93250 Kuching, Sarawak' AS orchard_add, '1.496086, 110.219608' AS orchard_location, 68001 AS userID)
	 ...
	 $sqlTreeData = "INSERT INTO Tree(TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID)
	  SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
		FROM (SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7001 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
		...
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7002 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
		...
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7003 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
		...
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7004 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
		...
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7005 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
		...
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7006 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493843, 110.220334' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			AS tem_6 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7006)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7007 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493937, 110.220366' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			AS tem_7 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7007)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7008 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493844, 110.220441' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			AS tem_8 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7008)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7009 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status,'1.493901, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			AS tem_9 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7009)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7010 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493901, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5002 AS BlockID)
			AS tem_10 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7010)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7011 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			AS tem_11 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7011)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7012 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			AS tem_12 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7012)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7013 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			AS tem_13 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7013)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7014 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			AS tem_14 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7014)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7015 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5003 AS BlockID)
			AS tem_15 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7015)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7016 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			AS tem_16 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7016)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7017 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			AS tem_17 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7017)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7018 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			AS tem_18 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7018)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7019 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			AS tem_19 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7019)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7020 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.493661, 110.220412' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5004 AS BlockID)
			AS tem_20 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7020)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7021 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			AS tem_21 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7021)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7022 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			AS tem_22 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7022)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7023 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			AS tem_23 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7023)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7024 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			AS tem_24 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7024)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7025 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5005 AS BlockID)
			AS tem_25 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7025)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7026 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			AS tem_26 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7026)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7027 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			AS tem_27 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7027)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7028 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			AS tem_28 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7028)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7029 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			AS tem_29 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7029)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7030 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494305, 110.220380' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5006 AS BlockID)
			AS tem_30 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7030)	
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7031 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			AS tem_31 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7031)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7032 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			AS tem_32 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7032)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7033 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			AS tem_33 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7033)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7034 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			AS tem_34 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7034)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7035 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5007 AS BlockID)
			AS tem_35 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7035)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7036 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			AS tem_36 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7036)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7037 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			AS tem_37 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7037)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7038 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			AS tem_38 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7038)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7039 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			AS tem_39 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7039)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7040 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.494294, 110.219822' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5008 AS BlockID)
			AS tem_40 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7040)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7041 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2020-10-01' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Growing' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			AS tem_41 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7041)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7042 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2020-10-01' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Growing' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			AS tem_42 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7042)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7043 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-04-21' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			AS tem_43 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7043)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7044 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-05-17' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			AS tem_44 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7044)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7045 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5009 AS BlockID)
			AS tem_45 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7045)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7046 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-10-05' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			AS tem_46 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7046)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7047 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2020-08-18' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Growing' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			AS tem_47 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7047)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7048 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2020-08-18' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Growing' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			AS tem_48 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7048)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7049 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2020-08-18' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Growing' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			AS tem_49 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7049)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7050 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-05-27' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495369, 110.220404' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5010 AS BlockID)
			AS tem_50 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7050)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7051 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			AS tem_51 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7051)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7052 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			AS tem_52 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7052)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7053 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			AS tem_53 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7053)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7054 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Flowering' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			AS tem_54 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7054)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7055 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image,'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5011 AS BlockID)
			AS tem_55 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7055)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7056 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mango' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			AS tem_56 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7056)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7057 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			AS tem_57 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7057)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7058 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Flowering' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			AS tem_58 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7058)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7059 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Flowering' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			AS tem_59 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7059)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7060 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image,'Mangosteen' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.495603, 110.219522' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5012 AS BlockID)
			AS tem_60 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7060)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7061 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			AS tem_61 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7061)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7062 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			AS tem_62 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7062)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7063 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			AS tem_63 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7063)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7064 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			AS tem_64 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7064)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7065 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image,'Mango' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5013 AS BlockID)
			AS tem_65 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7065)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7066 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			AS tem_66 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7066)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7067 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			AS tem_67 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7067)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7068 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			AS tem_68 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7068)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7069 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			AS tem_69 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7069)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7070 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image,'Mangosteen' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status, '1.496000, 110.220724' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5014 AS BlockID)
			AS tem_70 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7070)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7071 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Mango' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Flowering' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			AS tem_71 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7071)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7072 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Growing' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			AS tem_72 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7072)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7073 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			AS tem_73 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7073)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7074 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			AS tem_74 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7074)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7075 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image,'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5015 AS BlockID)
			AS tem_75 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7075)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7076 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
			AS tem_76 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7076)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7077 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Flowering' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
			AS tem_77 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7077)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7078 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
			AS tem_78 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7078)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7079 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
			AS tem_79 WHERE NOT EXISTS (SELECT TreeID FROM Tree WHERE TreeID = 7079)
		UNION ALL
			SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7080 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\tree.jpg') AS tree_Image,'Mangosteen' AS spesiesName, '2015-05-26' AS plantDate,
			'40m' AS tree_height,'110cm' AS diameter, 'Bear fruits' AS status,'1.496086, 110.219608' AS GPS_location, 'evergreen tropical tree' AS tree_type, 5016 AS BlockID)
	 ...
	 SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
		FROM (SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31001 AS userID, 5001 AS BlockID, '2021-06-12' AS purchaseDate, 1 AS blockQty, 'RM5000' AS totalPrice)
			AS tempp1 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31001 AND BlockID = 5001)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31002 AS userID, 5002 AS BlockID, '2019-07-23' AS purchaseDate, 1 AS blockQty, 'RM4599' AS totalPrice)
			AS tempp2 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31002 AND BlockID = 5002)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31002 AS userID, 5003 AS BlockID, '2019-11-02' AS purchaseDate, 1 AS blockQty, 'RM3899' AS totalPrice)
			AS tempp3 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31002 AND BlockID = 5003)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
		...
		UNION ALL
			...
			AS tempp5 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31004 AND BlockID = 5007)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31004 AS userID, 5014 AS BlockID, '2022-03-03' AS purchaseDate, 1 AS blockQty, 'RM4399' AS totalPrice)
			AS tempp6 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31004 AND BlockID = 5014)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31005 AS userID, 5005 AS BlockID, '2022-01-04' AS purchaseDate, 1 AS blockQty, 'RM4100' AS totalPrice)
			AS tempp7 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31005 AND BlockID = 5005)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31005 AS userID, 5006 AS BlockID, '2022-01-04' AS purchaseDate, 1 AS blockQty, 'RM5300' AS totalPrice)
			AS tempp8 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31005 AND BlockID = 5006)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31006 AS userID, 5010 AS BlockID, '2019-10-15' AS purchaseDate, 1 AS blockQty, 'RM5388' AS totalPrice)
			AS tempp9 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31006 AND BlockID = 5010)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31007 AS userID, 5011 AS BlockID, '2019-12-26' AS purchaseDate, 1 AS blockQty, 'RM4888' AS totalPrice)
			AS tempp10 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31007 AND BlockID = 5011)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31007 AS userID, 5012 AS BlockID, '2021-07-23' AS purchaseDate, 1 AS blockQty, 'RM5888' AS totalPrice)
			AS tempp11 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31007 AND BlockID = 5012)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31008 AS userID, 5013 AS BlockID, '2022-01-04' AS purchaseDate, 1 AS blockQty, 'RM4688' AS totalPrice)
			AS tempp12 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31008 AND BlockID = 5013)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31009 AS userID, 5015 AS BlockID, '2021-04-12' AS purchaseDate, 1 AS blockQty, 'RM4000' AS totalPrice)
			AS tempp13 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31009 AND BlockID = 5015)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31009 AS userID, 5016 AS BlockID, '2021-12-17' AS purchaseDate, 1 AS blockQty, 'RM4388' AS totalPrice)
			AS tempp14 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31009 AND BlockID = 5016)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31010 AS userID, 5008 AS BlockID, '2020-11-09' AS purchaseDate, 1 AS blockQty, 'RM5000' AS totalPrice)
			AS tempp15 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31010 AND BlockID = 5008)
		UNION ALL
			SELECT userID,BlockID,purchaseDate,blockQty,totalPrice
			FROM (SELECT 31010 AS userID, 5009 AS BlockID, '2020-11-09' AS purchaseDate, 1 AS blockQty, 'RM6388' AS totalPrice)
			AS tempp16 WHERE NOT EXISTS (SELECT userID,BlockID FROM Block_Client WHERE userID = 31010 AND BlockID = 5009)
	) alias_Block_Client";
