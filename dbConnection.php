<?php	
	...
	SELECT userID,worker_position,worker_department,workerDOB
	 ...
	 SELECT userID,client_photo
		...
		FROM (SELECT 10011 AS userID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\woman.jpg') AS client_photo)
			AS temp_36 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10011)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10012 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_37 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10012)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10013 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_38 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10013)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10014 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_39 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10014)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10015 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_40 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10015)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10016 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_41 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10016)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10017 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_42 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10017)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10018 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_43 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10018)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10019 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\man.jpg') AS client_photo)
			AS temp_44 WHERE NOT EXISTS (SELECT userID FROM Client WHERE userID = 10019)
		UNION ALL
			SELECT userID,client_photo
			FROM (SELECT 10020 AS userID,  LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\woman.jpg') AS client_photo)
	 ...
	 if (mysqli_query($conn, $sqlClientData))
	{
	 ...
	 SELECT userID,companyDesc,companyPhoto
		...
		FROM (SELECT 10021 AS userID, 'Corporate office' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_46 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 10021)
		UNION ALL
			SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 10022 AS userID, 'Agricultural' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_47 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 10022)
		UNION ALL
			SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 10023 AS userID, 'Plantation' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_48 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 10023)
		UNION ALL
			SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 10024 AS userID, 'Manufacturer' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
			AS temp_49 WHERE NOT EXISTS (SELECT userID FROM Company WHERE userID = 10024)
		UNION ALL
			SELECT userID,companyDesc,companyPhoto
			FROM (SELECT 10025 AS userID, 'Plantation' AS companyDesc, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\company.jpg') AS companyPhoto)
	 ...
	 $sqlTreeData = "INSERT INTO Tree(TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID)
	  SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
		FROM (SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
			FROM (SELECT 7001 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7002 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7003 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7004 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7005 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2012-03-08' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7006 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7007 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7008 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7009 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7010 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-23' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7011 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7012 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7013 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7014 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7015 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-03-27' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7016 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7017 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7018 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7019 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7020 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-15' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7021 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7022 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7023 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7024 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7025 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-07-21' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7026 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\cempedak\\tree.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7027 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\cempedak.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7028 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\cempedak.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7029 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\cempedak.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7030 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\cempedak.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7031 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7032 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7033 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7034 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7035 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-10' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7036 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7037 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7038 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7039 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7040 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-11' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7041 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2020-10-01' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7042 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2020-10-01' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7043 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-04-21' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7044 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-05-17' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7045 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-26' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7046 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-10-05' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7047 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2020-08-18' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7048 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2020-08-18' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7049 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2020-08-18' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7050 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\cempedak.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-05-27' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7051 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-31' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7052 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-05-11' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7053 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image, 'Mangosteen' AS spesiesName, '2012-04-27' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7054 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-06-02' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7055 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image,'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7056 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-10-10' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7057 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\cempedak.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-03' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7058 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-06-18' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7059 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-04-16' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7060 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image,'Mangosteen' AS spesiesName, '2012-05-01' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7061 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-31' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7062 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\cempedak.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-12' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7063 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-25' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7065 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image,'Mango' AS spesiesName, '2014-10-11' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7066 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7067 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-06-01' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7068 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-25' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7069 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2014-02-25' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7070 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image,'Mangosteen' AS spesiesName, '2012-05-21' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7071 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mango.jpg') AS tree_Image, 'Mango' AS spesiesName, '2014-11-06' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7072 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\dragonfruit.jpg') AS tree_Image, 'Dragon fruit' AS spesiesName, '2020-07-23' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7073 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\rambutan.jpg') AS tree_Image, 'Rambutan' AS spesiesName, '2016-05-24' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7074 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7075 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image,'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7076 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\durian.jpg') AS tree_Image, 'Musang King Durian' AS spesiesName, '2015-05-26' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7077 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\langsat.jpg') AS tree_Image, 'Langsat' AS spesiesName, '2012-06-28' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7078 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\cempedak.jpg') AS tree_Image, 'Cempedak' AS spesiesName, '2015-06-01' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7079 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\ciku.jpg') AS tree_Image, 'Ciku' AS spesiesName, '2015-05-26' AS plantDate,
			...
			UNION ALL
				SELECT TreeID,tree_Image,spesiesName, plantDate, tree_height,diameter,status,GPS_location,tree_type,BlockID
				FROM (SELECT 7080 AS TreeID, LOAD_FILE('C:\\xampp\\htdocs\\tmf2034\\project\\photo\\mangosteen.jpg') AS tree_Image,'Mangosteen' AS spesiesName, '2012-05-23' AS plantDate,
