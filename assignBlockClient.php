...
<body>
	...
	<div class="content">
		<table>
			...
			<?php
				$sql = "SELECT User.userID, User.userName, Block.BlockID, Block_Client.purchaseDate, 
					Block_Client.totalPrice, Client.client_photo FROM User
		...
		<a href="assignBlockClientForm.php"><button> Assign block to client </button></a>
