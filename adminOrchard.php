					...
					while($row = $result->fetch_assoc())
					{
						echo "
							<tr>
								...
								<td>$row[userID]</td>
								<td><a class='btn btn-primary btn-sm' href='adminUpdateOrchard.php?orchardID=$row[orchardID]'>Update</a>
								<a class='btn btn-primary btn-sm' href='adminDeleteOrchard.php?orchardID=$row[orchardID]'>Delete</a></td>
							</tr>
						";
					}
				?>
